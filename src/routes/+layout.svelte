...
<div class:hidden={!navbarVisible}>
  ...
  >
    <NavBrand href="/">
      <img
        src={shihabdinlogo}
        class="rounded-full me-3 h-14 md:h-16 z-50"
        alt="Shihabdin Logo"
      />
      <span
        style="font-family:'Protest Guerrilla', system-ui;font-weight: 400;font-style: normal;"
        class="self-center whitespace-nowrap text-3xl text-primary-50"
        >Shihabdin
      </span>
    </NavBrand>
    ...
    <NavUl class="-mt-6 z-40 md:-mt-0">
      <NavLi
        ...
        class="text-black  md:text-white md:text-xl">Home</NavLi
      >
      <NavLi
        href="/projects"
        on:click={() => {
        ...
        class="text-black  md:text-white md:text-xl">Projects</NavLi
      >
      <NavLi
        href="/services"
        on:click={() => {
        ...
        class="text-black  md:text-white md:text-xl">Services</NavLi
      >
      <NavLi
        href="/contact"
        on:click={() => {
        ...
        class="text-black  md:text-white md:text-xl">Contact</NavLi
      >
