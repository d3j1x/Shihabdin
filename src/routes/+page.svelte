...
<svelte:head>
  <title>𝐒𝐡𝐢𝐡𝐚𝐛𝐝𝐢𝐧 ✪</title>
  <meta name="description" content="Shihabdin Official Portfolio.
  Cybersecurity specialist 🔐 | Full-Stack Developer 🛠 | Opensource 🔥.
  "/>
</svelte:head>
  ...
  <div class="hero__body opacity-0 grid grid-cols-1 md:grid-cols-2 
    ...
    bg-black transition-transform duration-300 hover:scale-105 hover:bg-transparent">
        ...
        backdrop-blur-none">
            ...
            <p class="mb-2 px-4 font-bold text-gray-400 text-lg lg:text-xl lg:my-4 text-center goldHover">
    ...
    <div class="bg-primary-950 myCustombg2 rounded-md col-span-1 mx-auto md:my-16  
...
<style>
 ...
 .goldHover:hover {
  ...
  background: linear-gradient(to bottom, #fefcbf, #f59e0b); /* Gradient from yellow-100 (#fefcbf) to yellow-500 (#f59e0b) */
